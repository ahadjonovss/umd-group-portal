...
export const metadata: Metadata = {
  title: "Apple App Store Transfer — UMD GROUP",
};
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Apple App Store — App Transfer</h1>
          <p className="text-sm text-gray-500 mt-1">Ilovani App Store Connect akkauntdan bizning akkauntga o&apos;tkazish</p>
        </div>
