  ...
  return (
    <>
      ...
      <div className="text-center mb-6 animate-slide-up delay-300">
        <div className="inline-flex items-center gap-2 bg-amber-50 text-amber-700 text-xs font-medium px-3 py-1.5 rounded-full mb-3 ring-1 ring-amber-200">
        ...
        {canReview && (
          <div className="mt-3">
            <button
              ...
              className="inline-flex items-center gap-2 h-9 px-4 bg-blue-600 text-white text-sm font-medium rounded-xl hover:bg-blue-700 active:scale-95 transition-all shadow-sm shadow-blue-200"
            >
